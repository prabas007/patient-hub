...
export const EMOTION_THEMES: Record<EsiCategory, EmotionTheme> = {
  neutral: {
    pageBg:        "bg-[#e2e0e0]",
    pageText:      "text-[#3a3030]",
    cardBg:        "bg-white",
    cardBorder:    "border-[#b0aeae]",
    accent:        "text-[#5c3d9e]",
    accentBg:      "bg-[#ede8f7]",
    accentBorder:  "border-[#c5bde0]",
    buttonBg:      "bg-[#5c3d9e] hover:bg-[#4a3282]",
    buttonHover:   "hover:bg-[#4a3282]",
    buttonShadow:  "shadow-[#c5bde0]",
    micIdle:       "bg-[#5c3d9e]",
    micRecording:  "bg-red-500",
    summaryBg:     "bg-[#ede8f7]",
    summaryBorder: "border-[#c5bde0]",
    summaryText:   "text-[#3a3030]",
    summaryAccent: "text-[#5c3d9e]",
    label:         "Neutral",
...
export const EMOTION_CSS_VARS: Record<EsiCategory, Record<string, string>> = {
  neutral: {
    "--theme-bg":          "#e2e0e0",
    "--theme-accent":      "#5c3d9e",
    "--theme-accent-soft": "#ede8f7",
    "--theme-text":        "#3a3030",
    "--theme-border":      "#c5bde0",
    "--theme-btn":         "#5c3d9e",
    "--theme-summary-bg":  "#ede8f7",
  },
  calm: {
    "--theme-bg":          "#f8fafc",
    "--theme-accent":      "#2563eb",
