...
export function CircleMemberCard({
  ...
  return (
    <div className="relative bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex items-start gap-3">
      {/* Avatar */}
      <div
      ...
      <div className="min-w-0 flex-1 pr-6">
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <span className="text-xs text-gray-400">{member.joinedDaysAgo}d ago</span>
        </div>
      </div>
