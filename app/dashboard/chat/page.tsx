    ...
    <PageTransition>
      ...
      {mode === "personal" && (
        <div className="flex gap-4 h-[520px]">
          ...
          <div className="w-72 shrink-0 flex flex-col border border-gray-200 rounded-2xl overflow-hidden">
            {/* Search bar */}
            <div className="p-3 border-b border-gray-100 bg-white">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white transition-colors"
                />
              </div>
            </div>
          ...
          <div className="flex-1 flex flex-col border border-gray-200 rounded-2xl overflow-hidden">
            {activeConv ? (
              <>
                {/* Conversation header */}
                <div className="px-4 py-3 border-b border-gray-100 bg-white flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Personal connection</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={!input.trim()}
                    className="px-4 py-2 bg-blue-600 text-white rounded-xl text-sm font-medium hover:bg-blue-700 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    Send
                  </button>
                </form>
