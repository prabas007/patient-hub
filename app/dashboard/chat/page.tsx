        ...
        <div className="flex bg-stone-100 rounded-xl p-1 gap-1">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
              mode === "circle" ? "bg-white text-amber-700 shadow-sm" : "text-stone-500 hover:text-stone-700"
            }`}
          >
            Match Circle Chat
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
              mode === "personal" ? "bg-white text-amber-700 shadow-sm" : "text-stone-500 hover:text-stone-700"
            }`}
          >
            Personal Chats
          </button>
              ...
              <>
                ...
                <form onSubmit={sendPersonalMessage} className="p-3 border-t border-stone-100 bg-white flex gap-2">
                  <input
                    ...
                    disabled={checking}
                    className="flex-1 border border-stone-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent disabled:opacity-60"
                  />
                  <button
                    type="submit"
                    disabled={!input.trim() || checking}
                    className="px-4 py-2 bg-amber-600 text-white rounded-xl text-sm font-medium hover:bg-amber-700 transition-colors disabled:opacity-40 disabled:cursor-not-allowed min-w-[64px]"
                  >
                    {checking ? (
